...
export default defineConfig({
  integrations: [
    starlight({
      ...
      editLink: {
        baseUrl:
          "https://github.com/NoroffFEU/development-platforms/edit/main/",
      },
      lastUpdated: true,
      pagination: false,
      sidebar: [
        ...
        },
        {
          label: "Akamai",
          collapsed: true,
          autogenerate: { directory: "akamai" },
        },
        {
          label: "Amazon",
          collapsed: true,
          autogenerate: { directory: "amazon" },
        },
        ...
        { label: "CMS", collapsed: true, autogenerate: { directory: "cms" } },
        {
          label: "CodePen",
          collapsed: true,
          autogenerate: { directory: "codepen" },
        },
        {
          label: "Databases",
          collapsed: true,
        ...
        },
        {
          label: "Microsoft",
          collapsed: true,
          autogenerate: { directory: "microsoft" },
        },
        {
        ...
        { label: "QA", collapsed: true, autogenerate: { directory: "qa" } },
        {
          label: "Railway",
          collapsed: true,
          autogenerate: { directory: "railway" },
        },
        {
          label: "Rasberry Pi",
          collapsed: true,
          autogenerate: { directory: "rasberry-pi" },
        },
        {
          label: "Reverse Proxy",
          collapsed: true,
        ...
        },
        {
          label: "ServiceNow",
          collapsed: true,
          autogenerate: { directory: "servicenow" },
        },
        {
          label: "SheCodes",
          collapsed: true,
          autogenerate: { directory: "shecodes" },
        },
        {
          label: "Shopify",
          collapsed: true,
        ...
        },
        {
          label: "Squarespace",
          collapsed: true,
          autogenerate: { directory: "squarespace" },
        },
        {
          label: "TanStack",
          collapsed: true,
          autogenerate: { directory: "tanstack" },
        },
        {
          label: "UX Monitoring",
          collapsed: true,
          autogenerate: { directory: "ux-monitoring" },
        },
        {
          label: "Web Development & Hosting",
          collapsed: true,
          autogenerate: { directory: "webdev-hosting" },
        },
      ],
      components: {
